...
begin
Image1.Picture.Graphic.LoadFromFile('C:\Users\stud\Desktop\VESELKOV IVAN\LABA 8\dog.pcx');
end;

procedure TForm14.N2Click(Sender: TObject);
begin
Image1.Picture.Graphic.LoadFromFile('C:\Users\stud\Desktop\VESELKOV IVAN\LABA 8\cat.pcx');
end;
...
//Picture.Graphic.LoadFromFile('C:\1.bmp');
end;
